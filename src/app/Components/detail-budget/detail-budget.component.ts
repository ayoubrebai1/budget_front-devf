...
import { detailbudget } from 'src/app/Models/detailbudget';
...
export class DetailBudgetComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.getDetails();
    this.getTypeBudget();
    this.detailService.getDetailById(10).subscribe(
      (data: detailbudget) => {
        let detailBudget = data;
        console.log('Detail Budget:', detailBudget);
      },
      (error: any) => {
